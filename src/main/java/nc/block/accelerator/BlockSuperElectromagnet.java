...
public class BlockSuperElectromagnet extends BlockContainer implements ICTMBlock<ISubmapManager> {
	...
	public void registerBlockIcons(IIconRegister iconRegister) {
		manager = new SidedSubmapManagerCTM("accelerator/electromagnet/" + (this.isActive ? "Active" : "Idle"));
