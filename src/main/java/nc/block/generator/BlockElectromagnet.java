...
public class BlockElectromagnet extends BlockContainer  implements ICTMBlock<ISubmapManager> {
	...
	public void registerBlockIcons(IIconRegister iconRegister) {
		manager = new SidedSubmapManagerCTM("generator/fusionEM/" + (this.isActive ? "Active" : "Idle"));
