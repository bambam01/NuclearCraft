...
// public class EntityBrian extends EntityMob {
...
//         this.tasks.addTask(3, new EntityAITempt(this, 1.25D, NCItems.fishAndRicecake, false));
//     }
...
//             for (k = 0; k < j; ++k) {
//                 this.dropItem(NCItems.fishAndRicecake, 1);
//             }
