...
// 	        p_70186_1_ += this.rand.nextGaussian() * (double)(this.rand.nextBoolean() ? -1 : 1) * 0.0005D * (double)p_70186_8_;
// 	        p_70186_3_ += this.rand.nextGaussian() * (double)(this.rand.nextBoolean() ? -1 : 1) * 0.0005D * (double)p_70186_8_;
// 	        p_70186_5_ += this.rand.nextGaussian() * (double)(this.rand.nextBoolean() ? -1 : 1) * 0.0005D * (double)p_70186_8_;
...
// 	            if (this.canBePickedUp == 1 && !p_70100_1_.inventory.addItemStackToInventory(new ItemStack(NCItems.dUBullet, 1)))
// 	            {
// 	                flag = false;
// 	            }
