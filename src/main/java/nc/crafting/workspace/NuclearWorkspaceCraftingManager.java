...
public class NuclearWorkspaceCraftingManager {
	...
	public NuclearWorkspaceCraftingManager() {
    	...
    	if (NuclearCraft.workspace) {
	    	...
	    	this.addRecipe(new NuclearWorkspaceShapedOreRecipe(new ItemStack(NCBlocks.fissionReactorSteamIdle, 1), true, new Object[] {"FUTUF", "UHWHU", "TWMWT", "UHWHU", "FUTUF", 'N', new ItemStack(NCItems.parts, 1, 7), 'U', "plateAdvanced", 'T', "ingotTough", 'M', NCBlocks.fissionReactorGraphiteIdle, 'X', "plateDU", 'F', "ultimateCircuit", 'W', NCBlocks.waterCoolerBlock, 'H', "infiniteWater",}));
	    	...
	    	this.addRecipe(new NuclearWorkspaceShapedOreRecipe(new ItemStack(NCBlocks.supercoolerIdle, 1), true, new Object[] {"ASSSA", "UUUUU", "MMMMM", "UUUUU", "ASSSA", 'A', new ItemStack (NCItems.parts, 1, 9), 'T', new ItemStack (NCItems.parts, 1, 3), 'M', new ItemStack(NCItems.parts, 1, 13), 'U', "dustCryotheum", 'S', new ItemStack (NCItems.parts, 1, 3)}));
	    	...
	    	this.addRecipe(new NuclearWorkspaceShapedOreRecipe(new ItemStack(NCBlocks.CfRTG, 1), true, new Object[] {"GCCCG", "CTTTC", "CTXTC", "CTTTC", "GCCCG", 'G', "alloyUltimate", 'C', "plateLead", 'T', new ItemStack(NCItems.parts, 1, 90), 'X', new ItemStack(NCItems.fuel, 1, 140)}));
